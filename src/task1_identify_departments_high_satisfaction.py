...
def main():
    ...
    # Define file paths
    input_file = "/workspaces/spark-structured-api-employee-engagement-analysis-Saketh0306/input/employee_data.csv"
    output_file = "/workspaces/spark-structured-api-employee-engagement-analysis-Saketh0306/outputs/task1/departments_high_satisfaction.csv"
